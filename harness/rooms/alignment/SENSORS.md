...
|--------|-------|---------------|
| Gemma vision model | Vision | Use the configured Aligned Agent OS vision extension |
| Smaller local vision model | Vision (fast) | Configure the local provider in the control panel |
| Larger local vision model | Vision (premium) | Configure the local provider in the control panel |
