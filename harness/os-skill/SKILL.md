...
Default paths (the installer may use a custom `ALIGNED_AGENT_HOME`):

```text
%USERPROFILE%\.aligned-coding-agent-os\
%USERPROFILE%\.aligned-coding-agent-os\agent\
%USERPROFILE%\.aligned-coding-agent-os\workspace\
%USERPROFILE%\.aligned-coding-agent-os\agent\skills\
```
...
~/.aligned-coding-agent-os/agent/
~/.aligned-coding-agent-os/workspace/
~/.aligned-coding-agent-os/agent/skills/
```
