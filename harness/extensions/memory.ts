...
const MEMORIES_DIR = path.join(HOME_DIR, "workspace", "rooms", "memory");
...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    label: "Save a Memory",
    description:
      "Save a fact or piece of information to long-term memory. Memories are stored as markdown files in the private Aligned Agent OS runtime and persist across sessions.",
  ...
  pi.registerTool({
    ...
    description:
      "Search long-term memories by keyword or phrase. Searches memory files in the private Aligned Agent OS runtime and returns matching lines with file names.",
